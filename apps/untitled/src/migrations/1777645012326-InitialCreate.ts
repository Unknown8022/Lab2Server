...
export class InitialCreate1777645012326 implements MigrationInterface {
    name = 'InitialCreate1777645012326'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "battery" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "percentage" integer NOT NULL, "voltage" integer NOT NULL, "isCharging" boolean NOT NULL, "temperature" integer NOT NULL, CONSTRAINT "PK_48100ff77c357004dfd6a51efdf" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "sensor" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "type" character varying NOT NULL, "value" double precision NOT NULL DEFAULT '0', "isActive" boolean NOT NULL DEFAULT true, CONSTRAINT "PK_ccc38b9aa8b3e198b6503d5eee9" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "prosthesis" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "modelName" character varying NOT NULL, "batteryLevel" double precision NOT NULL DEFAULT '100', "userId" uuid, "engineId" uuid, CONSTRAINT "REL_649c5ef6382a6f6510fb9e61aa" UNIQUE ("engineId"), CONSTRAINT "PK_1a8dfedc5ed2489103db9adab3d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "engine" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "rotationPerSecondSpeed" double precision NOT NULL, "voltage" double precision, "electricCurrent" double precision, "power" double precision NOT NULL, "type" character varying NOT NULL, CONSTRAINT "PK_a53ad5b7b5302ec9de3e1f384aa" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "prosthesis_sensors_sensor" ("prosthesisId" uuid NOT NULL, "sensorId" uuid NOT NULL, CONSTRAINT "PK_5545689a6cfc0ff4ff4ef96b137" PRIMARY KEY ("prosthesisId", "sensorId"))`);
